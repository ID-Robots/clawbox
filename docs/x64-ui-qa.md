...
| QA-038 | P0 | Fixed | An installed Codex plugin migrated from v1 is enabled by default even without a config entry; that state bypassed package health and v2 capability consent, crash-looping the gateway even when a non-Codex model was primary. |
