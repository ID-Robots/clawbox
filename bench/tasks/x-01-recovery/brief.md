...
firmware, last-seen), with a summary bar counting devices per kind, filter
buttons per kind, and a detail panel that opens when a card is clicked. Static
files only, no network access, real copy throughout.
