...
The chat header may show more levels globally, but for the ClawBox AI (DeepSeek) provider only these three take effect; anything else is clamped or rejected by the gateway.
