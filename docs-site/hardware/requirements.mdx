...
- **Node.js 24.16–24.x, or 26.1+** (the pinned OpenClaw core refuses 25 and 26.0)
...
- **Examples:** $10–20/mo VPS · Raspberry Pi 5 (8 GB) · **ClawBox** · Mac Mini

### Power User — local AI models
- **Specs:** 4+ cores, 16 GB+ RAM, 100 GB+ SSD, 25 Mbps+, NVIDIA GPU, Linux (Ubuntu/Debian)
- **Can do:** everything above, plus local LLMs (1B–8B; 1–4B is the sweet spot on ClawBox), local image generation, on-device speech recognition, fully offline operation, multiple browser instances
- **Can't do:** 70B+ models need more VRAM → see [ClawBox Workstation](/hardware/clawbox-workstation)
- **Examples:** **ClawBox** (67 TOPS) · gaming PC with GPU · **ClawBox Workstation** (DGX Spark)
...
| **Lower long-term cost** — €749 once vs €20–40/mo VPS | €720–2,880 over 3 years |
