...
<Tip>
  ...
  📺 **Hands-on walkthrough (Portuguese)** — *"ClawBox: A Ferramenta que Muda Como Você Trabalha,"* including a manual ClawBox install via `installer.sh` → [watch on YouTube](https://youtu.be/KMDTF7N8uzU).
</Tip>
