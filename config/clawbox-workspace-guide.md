...
| `coding_agent_run` | Hand a task to a separate Claude Code session that works in the background inside one folder, on its own branch. Returns a run id at once — say it is running and stop. |
