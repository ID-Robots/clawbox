...
export default function OpenClawApp() {
  ...
  if (status === "checking") {
    return (
      <div className="h-full flex flex-col items-center justify-center gap-3 bg-[var(--win-ground)]">
  ...
  if (status === "not-running") {
    return (
      <div className="h-full flex flex-col items-center justify-center gap-6 p-8 bg-[var(--win-ground)]">
