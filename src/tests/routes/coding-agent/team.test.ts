...
describe("GET", () => {
  ...
  it("answers the board's shape and figures with it — what the bench reads", async () => {
    const metrics = { plannerRuns: 1, workerRuns: 2, reviewerRuns: 0, leadRuns: 1, tasksPlanned: 3, tasksAdded: 0, tasksRetired: 1, tasksAcceptedFirstTry: 2, tasksRejected: 0, tokensUsed: 42_000, wallMs: 90_000 };
