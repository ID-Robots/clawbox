  ...
  it("names the planner's shape, whether the lead may change the plan, the figures, a lead's task and the final review", async () => {
    apiGet.mockResolvedValueOnce({
      team: {
        ...
        metrics: { plannerRuns: 1, workerRuns: 3, reviewerRuns: 1, leadRuns: 2, tasksPlanned: 2, tasksAdded: 1, tasksRetired: 0, tasksAcceptedFirstTry: 3, tasksRejected: 0, tokensUsed: 184_000, wallMs: 754_400 },
      },
    });
    ...
    expect(text).toContain("Metrics: runs planner 1, worker 3, reviewer 1, lead 2; tasks planned 2, added 1, retired 0, accepted first try 3, rejected 0; tokens 184000; wall 754 s.");
