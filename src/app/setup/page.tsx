...
export default function ChromeDesktop() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden select-none">
      ...
      {/* Desktop grid for installed apps */}
      {installedAppDefs.length > 0 && (
        <div className="absolute inset-0 z-[1] flex items-center justify-center pb-20 pointer-events-none">
          <div className="grid grid-cols-5 gap-6 p-8 pointer-events-auto">
