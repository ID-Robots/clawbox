...
export const it: Record<string, string> = {
  ...
  "codingAgent.pausedAllowanceAudio": "In pausa: il limite giornaliero di audio è esaurito.",
  "codingAgent.pausedAllowanceSpeech": "In pausa: il limite per la voce è esaurito.",
  "codingAgent.pausedAllowanceTokens": "In pausa: il limite di token è esaurito.",
