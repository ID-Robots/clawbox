...
export const codingAgentEn: Record<string, string> = {
  ...
  "codingAgent.stepDeployWatching": "Watching Vercel for a deployment of {branch}",
  "codingAgent.stepDeployReady": "Deployed to {url}",
  "codingAgent.stepDeployFailed": "The Vercel deployment failed: {reason}",
  "codingAgent.stepDeployStopped": "Stopped watching Vercel: {reason}",
  "codingAgent.stepDeployFeedback": "The failed build's log was handed to {id}",
  "codingAgent.stepDeployFixTurn": "Fixing the Vercel build of {id}",
  "codingAgent.stepDeployPromoted": "Promoted to production: {url}",
  "codingAgent.deployTitle": "Deployment",
  "codingAgent.deployLooking": "Waiting for Vercel to start the build",
  "codingAgent.deployBuilding": "Building on Vercel",
  "codingAgent.deployReady": "The preview is up",
  "codingAgent.deployFailed": "The build failed",
  "codingAgent.deployCanceled": "The deployment was cancelled",
  "codingAgent.deployAbandoned": "This ClawBox stopped watching the build",
  "codingAgent.deployOpenBuild": "Build log on Vercel",
  "codingAgent.deployFixRun": "Fix run {id}",
  "codingAgent.deployPromotedBy": "Promoted to production by you",
  "codingAgent.deployPromote": "Promote to production",
  "codingAgent.deployPromoting": "Promoting…",
  "codingAgent.deployPromoteAsk": "Point production at this build?",
  "codingAgent.deployPromoteWarn": "Everyone using {project} sees this build straight away. This ClawBox never promotes a deployment on its own.",
  "codingAgent.deployPromoteYes": "Promote it",
  "codingAgent.deployPromoteFailed": "Could not promote: {reason}",
  "codingAgent.stepDeployStartedPreview": "Deploying a preview to Vercel",
  "codingAgent.stepDeployStartedProduction": "Deploying to production on Vercel",
  "codingAgent.deployActionsTitle": "Deploy",
  "codingAgent.deployPreviewAction": "Deploy a preview",
  "codingAgent.deployProductionAction": "Deploy to production",
  "codingAgent.deployStarting": "Deploying…",
  "codingAgent.deployStartFailed": "Could not deploy: {reason}",
  "codingAgent.deployProductionAsk": "Deploy this project to production?",
  "codingAgent.deployProductionWarn": "This build goes live on {project}'s own domain, where everyone using it sees it straight away.",
  "codingAgent.deployProductionWarnDomain": "This build goes live on {domain} ({project}), where everyone using it sees it straight away.",
  "codingAgent.deployProductionYes": "Deploy it",
  "codingAgent.deployTargetPreview": "preview",
  "codingAgent.deployTargetProduction": "production",
  "codingAgent.deployByAgent": "started by the assistant",
  "codingAgent.deployAutoProduction": "Let the assistant deploy this project to production",
  "codingAgent.deployAutoProductionHint": "Off by default. With it on, the assistant can put a build on this project's own domain without asking you first. Previews never need this.",
  "codingAgent.vercelTitle": "Vercel deploys",
  "codingAgent.vercelNone": "No Vercel project is attached, so runs in this project are not deployed.",
  "codingAgent.vercelAttach": "Attach a Vercel project",
  "codingAgent.vercelChange": "Change",
  "codingAgent.vercelDetach": "Detach",
  "codingAgent.vercelProjectLabel": "Vercel project id or name",
  "codingAgent.vercelTeamLabel": "Team id — leave empty for a personal account",
  "codingAgent.vercelTokenLabel": "Which saved secret holds the token",
  "codingAgent.vercelTokenHint": "Save the Vercel token as a secret on this ClawBox first; this form sends only its name. The box reads the stored value to sign in to Vercel, and never shows it to you or to the agent.",
  "codingAgent.vercelNoSecrets": "This ClawBox has no saved secrets yet. Save the Vercel token in the coding agent's settings first.",
  "codingAgent.vercelConnected": "Connected to Vercel as {user}",
  "codingAgent.vercelConnectedPlain": "Connected to Vercel",
  "codingAgent.vercelUnreachable": "This ClawBox could not reach Vercel, so it cannot say whether the link works.",
  "codingAgent.vercelProblem": "Vercel refused the link: {reason}",
  "codingAgent.vercelChecking": "Checking the link…",
  ...
  "codingAgent.delete.willMove": "The folder is moved to this ClawBox's deleted projects, not erased, and kept there for {days} days.",
  "codingAgent.delete.willRemoveVercel": "Its Vercel link is taken down.",
  ...
  "codingAgent.delete.retention": "It is kept there for {days} days, then removed.",
  "codingAgent.delete.vercelRemoved": "Its Vercel link was taken down.",
