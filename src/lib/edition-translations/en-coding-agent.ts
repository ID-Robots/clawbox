...
export const codingAgentEn: Record<string, string> = {
  ...
  "codingAgent.teamMembersTitle": "Team members",
  ...
  "codingAgent.maxParallelRunsHint": "Each run works in its own copy of the project on a branch of its own, so runs can no longer overwrite each other's half-finished files. How many make sense is a question about this ClawBox's memory: two is comfortable, four is a lot on a small board.",
  ...
  "codingAgent.secretsNamePlaceholder": "VERCEL_TOKEN",
  ...
  "codingAgent.secretsRefusedName": "A name is capital letters, digits and underscores, starting with a letter — like VERCEL_TOKEN.",
