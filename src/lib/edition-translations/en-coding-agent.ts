...
export const codingAgentEn: Record<string, string> = {
  ...
  "codingAgent.commitAuthorHint": "Who the box signs its own commits as when a project has no git identity of its own. The e-mail must belong to a GitHub account that can deploy the project on Vercel, or its deployment check rejects the commit. Leave both blank to use the project's own git settings.",
