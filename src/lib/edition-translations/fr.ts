...
export const fr: Record<string, string> = {
  ...
  "codingAgent.pausedAllowanceAudio": "En pause : le quota quotidien d'audio est épuisé.",
  "codingAgent.pausedAllowanceSpeech": "En pause : le quota de synthèse vocale est épuisé.",
  "codingAgent.pausedAllowanceTokens": "En pause : le quota de jetons est épuisé.",
