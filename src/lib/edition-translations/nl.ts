...
export const nl: Record<string, string> = {
  ...
  "codingAgent.pausedAllowanceAudio": "Gepauzeerd: het dagelijkse tegoed voor audio is op.",
  "codingAgent.pausedAllowanceSpeech": "Gepauzeerd: het tegoed voor spraak is op.",
  "codingAgent.pausedAllowanceTokens": "Gepauzeerd: het tegoed voor tokens is op.",
