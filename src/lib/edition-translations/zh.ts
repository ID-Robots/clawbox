...
export const zh: Record<string, string> = {
  ...
  "codingAgent.fileViewLabel": "此文件的显示方式",
  "codingAgent.filePreview": "预览",
  "codingAgent.fileSource": "源码",
  "codingAgent.fileWrap": "自动换行",
  "codingAgent.fileWrapHint": "自动换行显示长行，而不是横向滚动",
