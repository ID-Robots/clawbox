...
export const zh: Record<string, string> = {
  ...
  "localModels.cloud.title": "ClawBox AI 云端",
  "localModels.cloud.intro": "语音与记忆搜索在 ClawBox AI 订阅涵盖时使用云端，否则使用本机上的引擎。",
  "localModels.cloud.capability.tts": "语音（文字转语音）",
  "localModels.cloud.capability.stt": "语音转文字",
  "localModels.cloud.capability.embeddings": "记忆搜索",
  "localModels.cloud.onCloud": "云端",
  "localModels.cloud.onBox": "本机",
  "localModels.cloud.useLocal": "使用本机",
  "localModels.cloud.useCloud": "使用云端",
  "localModels.cloud.notConnected": "本机没有 ClawBox AI 订阅，因此这里的一切都在本机上运行。",
  "localModels.cloud.connect": "去连接",
  "localModels.cloud.reason.notLinked": "本机没有 ClawBox AI 订阅。",
  "localModels.cloud.reason.plan": "你的套餐不包含这一项。",
  "localModels.cloud.reason.routeUnavailable": "云端尚未提供这一项，因此由本机处理。",
  "localModels.cloud.reason.edition": "此版本在本机上搜索记忆。",
  "localModels.cloud.reason.owner": "你已选择本机上的引擎。",
  ...
  "localModels.install.working": "正在处理…",
  ...
  "localModels.gguf.title": "其他 llama.cpp 模型",
  "localModels.gguf.hint": "从 Hugging Face 取得任意 GGUF。它会留在这台盒子的模型库中；盒子仍然用它自己的模型来回答。",
  "localModels.gguf.repo": "仓库",
  "localModels.gguf.file": "文件",
  "localModels.gguf.check": "检查大小",
  "localModels.gguf.size": "下载 {size}・剩余 {free}",
  "localModels.gguf.sizeUnknown": "Hugging Face 没有说明该文件有多大。",
  "localModels.gguf.notFound": "Hugging Face 上没有这个仓库。",
  "localModels.gguf.noSuchFile": "该仓库里没有这个文件。",
  "localModels.gguf.alreadyHere": "该文件已经在这台盒子的模型库中。",
  "localModels.gguf.invalid": "请填写形如 owner/name 的仓库，以及以 .gguf 结尾的文件。",
  "localModels.gguf.inUse": "正用它回答",
  "localModels.gguf.noDownloader": "Hugging Face 的下载工具还不在这台盒子上。请先安装本地模型。",
};
