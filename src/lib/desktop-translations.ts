...
export const desktopTranslations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "settings.providers.title": "Connections",
    ...
    "settings.providers.makeDefaultOf": "Make {provider} the default provider",
    "settings.providers.openConfig": "Open {provider} settings",
    ...
    "settings.providers.empty": "No providers to show yet",
