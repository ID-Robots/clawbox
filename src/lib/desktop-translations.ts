...
export const desktopTranslations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "chat.emailBatch.cancel": "Send nothing",
    ...
    "settings.accountsConnect": "Connect an account",
    "settings.accountsHelper": "Connect an account so the assistant can reach you there.",
    "settings.accountsConnectedCount": "{n} connected",
    "settings.accountsTelegramHint": "Chat with the assistant on Telegram",
    "settings.accountsEmailHint": "Send and read mail",
    "settings.accountsWhatsappHint": "Chat with the assistant on WhatsApp",
    "settings.accountsDiscordHint": "Chat with the assistant on Discord",
