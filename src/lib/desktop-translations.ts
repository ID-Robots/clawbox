...
export const desktopTranslations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "remote.upgrade.featureName": "Remote Desktop",
    "remote.upgrade.description": "Remote Desktop publishes a secure tunnel from this ClawBox to your portal account so you can reach it from anywhere. Available on Pro and Max plans.",
