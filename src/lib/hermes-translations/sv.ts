...
export const sv: Record<string, string> = {
  ...
  "codingAgent.team.help": "En planerare delar upp målet i uppgifter, arbetare utför dem en i taget i egna sessioner och en granskare kontrollerar varje resultat. Varje steg finns på tavlan nedan.",
  ...
  "codingAgent.newTeamHint": "Assistenten startar ett kodningsteam i den mappen: en planerare delar upp målet i uppgifter, arbetare gör dem en i taget och en granskare kontrollerar varje resultat. Följ tavlan i appen Coding Agent.",
