...
export const sv: Record<string, string> = {
  ...
  "codingAgent.readyLine": "Claude Code, claude-ds och ClawBox AI är redo.",
  "codingAgent.folderLabel": "Standardmapp för projekt",
  "codingAgent.folderPlaceholder": "/home/clawbox/Projects",
  "codingAgent.folderHelp": "Var en körning arbetar när din assistent inte anger ett kodprojekt. Måste vara en mapp i ClawBox hemkatalog — inte själva ClawBox OS-mappen och ingen med inloggningsuppgifter. Lämna tomt för att kräva ett projekt varje gång.",
  ...
  "codingAgent.installed": "installerad",
  "codingAgent.connected": "ansluten",
  "codingAgent.missing": "saknas",
  "codingAgent.notConnected": "inte ansluten",
  "codingAgent.effortLabel": "Tankemöda",
  "codingAgent.effortHelp": "Hur noga kodagenten tänker vid varje steg. Högre är grundligare men långsammare och dyrare. Max är standard, eftersom en delegerad körning arbetar utan tillsyn.",
