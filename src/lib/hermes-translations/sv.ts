...
export const sv: Record<string, string> = {
  ...
  "codingAgent.liveViewMode": "Livevy",
  "codingAgent.liveViewExit": "Lämna livevyn",
  "codingAgent.liveWaiting": "Väntar på att körningen öppnar sin utskrift…",
  ...
  "codingAgent.helpersTitle": "Hjälpare i arbete",
