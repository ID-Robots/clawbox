...
export const sv: Record<string, string> = {
  ...
  "localModels.detail.embeddingsOff": "Minnessökningen pekar inte på den ännu. Ställ in den i Memory Shard.",
  "localModels.detail.embeddingsNotInstalled": "Inte installerad. Ställ in den i Memory Shard.",
