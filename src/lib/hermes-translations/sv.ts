...
export const sv: Record<string, string> = {
  ...
  "codingAgent.subagentsLabel": "Underagenter",
  ...
  "codingAgent.fullAccessLabel": "Full kommandoåtkomst",
  "codingAgent.fullAccessHelp": "Låter en körning använda vilket kommando som helst, inte bara bygg- och testverktyg.",
  "codingAgent.fullAccessOn": "En körning kan nu läsa och ändra alla filer på den här enheten, inklusive dina sparade nycklar och lösenord. Slå bara på detta för uppgifter du litar på.",
  "codingAgent.fullAccessFailed": "Den fulla kommandoåtkomsten kunde inte ändras.",
  "codingAgent.fullAccessBadge": "full åtkomst",
