...
export const sv: Record<string, string> = {
  ...
  "skills.facetCountsLoaded": "Siffrorna gäller de {n} inlästa färdigheterna, inte hela katalogen.",
  "skills.facetSafetyBrowseNote": "Säkerheten kontrolleras vid installationen, så den går bara att filtrera under ”Installerade”.",
  "skills.liveResults.one": "{n} färdighet matchar",
  "skills.liveResults.other": "{n} färdigheter matchar",
  "skills.liveResults.none": "Inga färdigheter matchar",
