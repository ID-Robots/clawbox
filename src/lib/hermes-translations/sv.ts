...
export const sv: Record<string, string> = {
  ...
  "codingAgent.limits": "En körning stannar av sig själv efter {turns} steg eller ${budget} i modellanvändning. Det finns ingen tidsgräns — den stannar bara om den är tyst länge.",
