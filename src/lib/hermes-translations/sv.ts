...
export const sv: Record<string, string> = {
  ...
  "localModels.runtime.runsExtraModels": "Kör extra modeller på den här boxen",
  ...
  "localModels.detail.ollamaNotInstalled": "Inte installerad.",
  "localModels.detail.ollamaOff": "Av. Slå på den från menyn.",
  "localModels.detail.ollamaStandby": "Sover för att spara minne. Vaknar när en modell efterfrågas, eller slå på den nu från menyn.",
  "localModels.detail.ollamaFailed": "Stoppad efter ett fel. Slå på den från menyn.",
  "localModels.detail.ollamaChecking": "På. Kontrollerar vilka modeller som är nedladdade…",
  "localModels.detail.ollamaServing": "Serverar {names}.",
  "localModels.detail.ollamaNoModels": "På, men inga modeller är nedladdade ännu.",
  ...
  "localModels.detail.embeddingsOff": "Ingen minnesmodell svarar, så minnessökningen är av.",
  "localModels.detail.embeddingsAsleep": "{host} sover, så minnessökningen är pausad tills den vaknar.",
  "localModels.detail.embeddingsPaused": "{host} är av, så minnessökningen är pausad.",
