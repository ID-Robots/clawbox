...
export const sv: Record<string, string> = {
  ...
  "codingAgent.fullAccessHelp": "Som standard får en körning bara använda bygg- och testkommandon från en fast lista. Slår du på detta får den köra vilket kommando som helst i sin mapp, även sådana som raderar filer, installerar paket eller når nätverket.",
  "codingAgent.fullAccessOn": "På. Dina inloggningsfiler är fortfarande skyddade och en körning kan alltjämt inte lämna ClawBox-hemmappen eller ändra ClawBox självt — men det finns inte längre någon gräns för vilka kommandon den kör.",
  ...
  "codingAgent.limitsHelp": "En körning slutar när den är klar, får slut på steg eller når tokengränsen om du sätter en. Det finns ingen tidsgräns och ingen kostnadsgräns — ett långt projekt får arbeta i timmar och stannar av sig själv bara om det är tyst länge.",
