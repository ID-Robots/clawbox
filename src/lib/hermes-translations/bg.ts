...
export const bg: Record<string, string> = {
  ...
  "codingAgent.limits": "Изпълнението спира само след {turns} стъпки или ${budget} използване на модела. Няма ограничение във времето — спира само ако замълчи задълго.",
