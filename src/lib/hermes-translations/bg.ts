...
export const bg: Record<string, string> = {
  ...
  "codingAgent.team.help": "Планировчик разделя целта на задачи, работници ги изпълняват една след друга в свои сесии, а рецензент проверява всеки резултат. Всяка стъпка е на дъската по-долу.",
  ...
  "codingAgent.newTeamHint": "Асистентът стартира екип за програмиране в тази папка: планиращ разделя целта на задачи, работници ги изпълняват една след друга, а рецензент проверява всеки резултат. Следи дъската в приложението Coding Agent.",
