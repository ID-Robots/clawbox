...
export const bg: Record<string, string> = {
  ...
  "localModels.detail.embeddingsOff": "Търсенето в паметта още не е насочено към него. Настройте го в Memory Shard.",
  "localModels.detail.embeddingsNotInstalled": "Не е инсталиран. Настройте го в Memory Shard.",
