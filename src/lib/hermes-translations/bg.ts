...
export const bg: Record<string, string> = {
  ...
  "codingAgent.fullAccessHelp": "Позволи на изпълнението да ползва всяка команда, не само инструменти за компилиране и тестове.",
  "codingAgent.fullAccessOn": "Изпълнението вече може да чете и променя всеки файл на това устройство, включително запазените ви ключове и пароли. Включвайте само за задачи, на които имате доверие.",
