...
export const bg: Record<string, string> = {
  ...
  "codingAgent.liveView": "На живо",
  "codingAgent.livePreviewTitle": "Терминал на живо",
  "codingAgent.livePreviewShow": "Покажи терминала на живо",
  "codingAgent.livePreviewHide": "Скрий терминала на живо",
  "codingAgent.livePreviewClose": "Затвори терминала на живо",
  "codingAgent.livePreviewOpenApp": "Отвори в Терминал",
  "codingAgent.livePreviewNotYet": "Още няма какво да се покаже — изпълнението не е записало транскрипта си.",
