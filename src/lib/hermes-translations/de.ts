...
export const de: Record<string, string> = {
  ...
  "codingAgent.limits": "Ein Lauf stoppt von selbst nach {turns} Schritten oder ${budget} Modellnutzung. Es gibt kein Zeitlimit — er stoppt nur, wenn er lange still bleibt.",
