...
export const de: Record<string, string> = {
  ...
  "codingAgent.fullAccessHelp": "Erlaubt einem Lauf jeden Befehl, nicht nur Build- und Test-Tools.",
  "codingAgent.fullAccessOn": "Ein Lauf kann jetzt jede Datei auf diesem Gerät lesen und ändern, auch Ihre gespeicherten Schlüssel und Passwörter. Nur für Aufgaben aktivieren, denen Sie vertrauen.",
