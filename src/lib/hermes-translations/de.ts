...
export const de: Record<string, string> = {
  ...
  "codingAgent.fileLiveEdit": "In diesem Ordner arbeitet ein Lauf — sein nächster Commit nimmt deine Änderung mit.",
  ...
  "codingAgent.importNotConnected": "Verbinde in den Einstellungen ein GitHub-Konto, um deine Repositories zu sehen.",
  ...
  "codingAgent.importFolderHint": "Der Ordner wird in deinen Projektordner kopiert. node_modules bleibt zurück, und ein Ordner ohne Git-Historie bekommt eine.",
  ...
  "codingAgent.genImagesHint": "Ein Lauf kann diese Box bitten, Grafiken für das Projekt zu zeichnen, an dem er arbeitet, und die Box zeichnet kurz nach dem Start eines Laufs selbst das Desktop-Symbol des Projekts sowie favicon.png und favicon.ico. Jedes Bild geht von deinem täglichen ClawBox-AI-Kontingent ab; ein Lauf bekommt höchstens zwanzig.",
  ...
  "codingAgent.genAudioHint": "Ein Lauf kann diese Box einen Satz sprechen lassen und ihn als Audiodatei im Projekt speichern — Erzählung, Begrüßung, gesprochener Hinweis. Es ist dieselbe Stimme wie bei deinen gesprochenen Antworten, und sie wartet hinter ihnen; ein Lauf bekommt höchstens vierzig Clips.",
