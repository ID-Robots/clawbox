...
export const de: Record<string, string> = {
  ...
  "codingAgent.readiness": "Was ein Lauf braucht",
  "codingAgent.readyLine": "Claude Code, claude-ds und ClawBox AI sind bereit.",
  "codingAgent.folderLabel": "Standard-Projektordner",
  "codingAgent.folderPlaceholder": "/home/clawbox/Projects",
  "codingAgent.folderHelp": "Wo ein Lauf arbeitet, wenn Ihr Assistent kein Code-Projekt nennt. Muss ein Ordner im ClawBox-Home sein — nicht der ClawBox-OS-Ordner selbst und keiner mit Zugangsdaten. Leer lassen, um jedes Mal ein Projekt zu verlangen.",
  ...
  "codingAgent.installed": "installiert",
  "codingAgent.connected": "verbunden",
  "codingAgent.missing": "fehlt",
  "codingAgent.notConnected": "nicht verbunden",
  "codingAgent.effortLabel": "Denkaufwand",
  "codingAgent.effortHelp": "Wie gründlich der Coding-Agent bei jedem Schritt denkt. Höher ist gründlicher, aber langsamer und teurer. Max ist die Vorgabe, weil ein delegierter Lauf unbeaufsichtigt arbeitet.",
  ...
  "codingAgent.fullAccessLabel": "Voller Befehlszugriff",
  "codingAgent.fullAccessHelp": "Standardmäßig darf ein Lauf nur Build- und Testbefehle aus einer festen Liste nutzen. Ist dies an, darf er jeden Befehl in seinem Ordner ausführen, auch solche, die Dateien löschen, Pakete installieren oder ins Netz gehen.",
  "codingAgent.fullAccessOn": "An. Ihre Zugangsdaten bleiben geschützt und ein Lauf kann das ClawBox-Home weiterhin nicht verlassen oder ClawBox selbst ändern — aber es gibt keine Grenze mehr dafür, welche Befehle er ausführt.",
  "codingAgent.fullAccessFailed": "Der volle Befehlszugriff konnte nicht geändert werden.",
  "codingAgent.fullAccessBadge": "voller Zugriff",
  ...
  "codingAgent.limitsHelp": "Ein Lauf endet, wenn er fertig ist, seine Schritte aufgebraucht hat oder das Token-Limit erreicht, falls Sie eines setzen. Es gibt kein Zeit- und kein Kostenlimit — ein langes Projekt darf stundenlang arbeiten und stoppt von selbst nur, wenn es lange still bleibt.",
