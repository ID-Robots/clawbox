...
export const de: Record<string, string> = {
  ...
  "codingAgent.team.help": "Ein Planer zerlegt ein Ziel in Aufgaben, Arbeiter erledigen sie nacheinander in eigenen Sitzungen, und ein Prüfer kontrolliert jedes Ergebnis. Jeder Schritt steht unten auf der Tafel.",
  ...
  "codingAgent.newTeamHint": "Der Assistent startet in diesem Ordner ein Coding-Team: ein Planer teilt das Ziel in Aufgaben, Worker erledigen sie nacheinander, und ein Reviewer prüft jedes Ergebnis. Verfolge die Tafel in der Coding-Agent-App.",
