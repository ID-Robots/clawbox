...
export const de: Record<string, string> = {
  ...
  "localModels.detail.embeddingsOff": "Die Speichersuche zeigt noch nicht darauf. Richten Sie sie in Memory Shard ein.",
  "localModels.detail.embeddingsNotInstalled": "Nicht installiert. Richten Sie es in Memory Shard ein.",
