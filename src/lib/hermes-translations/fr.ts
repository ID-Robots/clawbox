...
export const fr: Record<string, string> = {
  ...
  "codingAgent.liveView": "En direct",
  "codingAgent.livePreviewTitle": "Terminal en direct",
  "codingAgent.livePreviewShow": "Afficher le terminal en direct",
  "codingAgent.livePreviewHide": "Masquer le terminal en direct",
  "codingAgent.livePreviewClose": "Fermer le terminal en direct",
  "codingAgent.livePreviewOpenApp": "Ouvrir dans le Terminal",
  "codingAgent.livePreviewNotYet": "Rien à afficher pour l'instant — l'exécution n'a pas encore écrit sa transcription.",
