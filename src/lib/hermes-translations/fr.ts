...
export const fr: Record<string, string> = {
  ...
  "codingAgent.team.help": "Un planificateur découpe l'objectif en tâches, des ouvriers les réalisent l'une après l'autre dans leurs propres sessions, et un relecteur vérifie chaque résultat. Chaque étape figure sur le tableau ci-dessous.",
  ...
  "codingAgent.newTeamHint": "L'assistant démarre une équipe de codage dans ce dossier : un planificateur découpe l'objectif en tâches, des workers les réalisent l'une après l'autre et un relecteur vérifie chaque résultat. Suivez le tableau dans l'app Coding Agent.",
