...
export const fr: Record<string, string> = {
  ...
  "localModels.runtime.runsExtraModels": "Exécute des modèles supplémentaires sur cette box",
  ...
  "localModels.detail.ollamaNotInstalled": "Non installé.",
  "localModels.detail.ollamaOff": "Arrêté. Activez-le depuis le menu.",
  "localModels.detail.ollamaStandby": "En veille pour économiser la mémoire. Se réveille quand un modèle est demandé, ou allumez-le maintenant depuis le menu.",
  "localModels.detail.ollamaFailed": "Arrêté après une erreur. Activez-le depuis le menu.",
  "localModels.detail.ollamaChecking": "Actif. Vérification des modèles téléchargés…",
  "localModels.detail.ollamaServing": "Sert {names}.",
  "localModels.detail.ollamaNoModels": "Actif, sans aucun modèle téléchargé pour l'instant.",
  ...
  "localModels.detail.embeddingsOff": "Aucun modèle de mémoire ne répond, la recherche en mémoire est donc désactivée.",
  "localModels.detail.embeddingsAsleep": "{host} est en veille, la recherche en mémoire est donc en pause jusqu'à son réveil.",
  "localModels.detail.embeddingsPaused": "{host} est arrêté, la recherche en mémoire est donc en pause.",
