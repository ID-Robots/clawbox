...
export const fr: Record<string, string> = {
  ...
  "codingAgent.readyLine": "Claude Code, claude-ds et ClawBox AI sont prêts.",
  "codingAgent.folderLabel": "Dossier de projets par défaut",
  "codingAgent.folderPlaceholder": "/home/clawbox/Projects",
  "codingAgent.folderHelp": "Où une exécution travaille quand votre assistant ne nomme pas de projet. Doit être un dossier dans le répertoire personnel ClawBox — pas le dossier ClawBox OS lui-même, ni un dossier contenant des identifiants. Laissez vide pour exiger un projet à chaque fois.",
  ...
  "codingAgent.installed": "installé",
  "codingAgent.connected": "connecté",
  "codingAgent.missing": "manquant",
  "codingAgent.notConnected": "non connecté",
  "codingAgent.effortLabel": "Effort de réflexion",
  "codingAgent.effortHelp": "À quel point l'agent réfléchit à chaque étape. Plus élevé est plus minutieux, mais plus lent et plus coûteux. Max est la valeur par défaut, car une exécution déléguée travaille sans surveillance.",
  ...
  "codingAgent.subagentsLabel": "Autoriser les sous-agents",
  "codingAgent.subagentsHelp": "Une exécution peut répartir un travail large entre des agents auxiliaires qui cherchent ou modifient en parallèle. Chacun est une conversation entière, donc cela coûte plus cher et utilise plus de mémoire. Désactivé par défaut ; utile pour un travail sur de nombreux fichiers.",
  "codingAgent.subagentsFailed": "Impossible de modifier le réglage des sous-agents.",
  "codingAgent.thinking": "réfléchit · {n} jetons",
  "codingAgent.subagentsActive": "{n} sous-agents au travail",
  "codingAgent.subagentsUsed": "{n} sous-agents",
  "codingAgent.fullAccessLabel": "Accès complet aux commandes",
  "codingAgent.fullAccessHelp": "Par défaut, une exécution ne peut utiliser que des commandes de build et de test d'une liste fixe. Une fois activé, elle peut lancer n'importe quelle commande dans son dossier, y compris celles qui suppriment des fichiers, installent des paquets ou accèdent au réseau.",
  "codingAgent.fullAccessOn": "Activé. Vos fichiers d'identifiants restent protégés et une exécution ne peut toujours pas quitter le dossier ClawBox ni modifier ClawBox — mais plus rien ne limite les commandes qu'elle lance.",
  "codingAgent.fullAccessFailed": "Impossible de modifier l'accès complet aux commandes.",
  "codingAgent.fullAccessBadge": "accès complet",
  ...
  "codingAgent.limitsHelp": "Une exécution se termine quand elle a fini, épuise ses étapes ou atteint la limite de jetons si vous en fixez une. Il n'y a ni limite de temps ni limite de coût — un long projet peut travailler des heures et ne s'arrête seul que s'il reste silencieux longtemps.",
