...
export const fr: Record<string, string> = {
  ...
  "codingAgent.fullAccessHelp": "Autorise une exécution à utiliser n'importe quelle commande, pas seulement les outils de build et de test.",
  "codingAgent.fullAccessOn": "Une exécution peut désormais lire et modifier n'importe quel fichier de cet appareil, y compris vos clés et mots de passe enregistrés. À n'activer que pour des tâches de confiance.",
