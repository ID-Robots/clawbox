...
export const fr: Record<string, string> = {
  ...
  "codingAgent.limits": "Une exécution s'arrête d'elle-même après {turns} étapes ou ${budget} d'utilisation du modèle. Il n'y a pas de limite de temps — il ne s'arrête que s'il reste silencieux longtemps.",
