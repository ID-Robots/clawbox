...
export const fr: Record<string, string> = {
  ...
  "codingAgent.projectRuns": "Tâches",
  "codingAgent.otherRuns": "Autres tâches",
  "codingAgent.gitTitle": "Dépôt Git",
  "codingAgent.gitCommits": "{n} validations",
  ...
  "codingAgent.pauseFailed": "Impossible de mettre la tâche en pause.",
  "codingAgent.resumeFailed": "Impossible de reprendre la tâche.",
  "codingAgent.startFailed": "Impossible de démarrer la tâche préparée.",
  ...
  "codingAgent.chatDraft": "Tâche enregistrée comme brouillon",
  "codingAgent.timeLeft": "restant",
