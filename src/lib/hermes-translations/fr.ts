...
export const fr: Record<string, string> = {
  ...
  "localModels.detail.embeddingsOff": "La recherche en mémoire ne pointe pas encore dessus. Configurez-la dans Memory Shard.",
  "localModels.detail.embeddingsNotInstalled": "Non installé. Configurez-le dans Memory Shard.",
