...
export const fr: Record<string, string> = {
  ...
  "codingAgent.newNamePlaceholder": "Minuteur Pomodoro",
  "codingAgent.newWhatLabel": "Que doit-elle faire ?",
  "codingAgent.newWhatPlaceholder": "Un minuteur avec des blocs de travail de 25 minutes et des pauses de 5 minutes, avec un son à la fin de chacun.",
