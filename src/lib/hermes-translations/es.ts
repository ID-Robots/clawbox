...
export const es: Record<string, string> = {
  ...
  "codingAgent.fullAccessHelp": "Permite que una ejecución use cualquier comando, no solo herramientas de compilación y prueba.",
  "codingAgent.fullAccessOn": "Una ejecución ahora puede leer y modificar cualquier archivo de este dispositivo, incluidas tus claves y contraseñas guardadas. Actívalo solo para tareas en las que confíes.",
