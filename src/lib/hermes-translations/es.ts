...
export const es: Record<string, string> = {
  ...
  "codingAgent.newNamePlaceholder": "Temporizador Pomodoro",
  "codingAgent.newWhatLabel": "¿Qué debe hacer?",
  "codingAgent.newWhatPlaceholder": "Un temporizador con bloques de trabajo de 25 minutos y descansos de 5, con un sonido al terminar cada uno.",
