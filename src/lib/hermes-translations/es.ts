...
export const es: Record<string, string> = {
  ...
  "codingAgent.terminalHint": "Las tareas de programación que tu asistente delega. Para una sesión interactiva, abre la app Terminal y ejecuta claude-ds.",
  ...
  "codingAgent.switchHelp": "Cuando está activado, tu asistente puede entregar una tarea de programación a Claude Code, que trabaja en segundo plano dentro de una carpeta de proyecto con tu plan de ClawBox AI e informa al terminar. Desactivado por defecto.",
  "codingAgent.readiness": "Lo que necesita una ejecución",
  "codingAgent.readyLine": "Claude Code, claude-ds y ClawBox AI están listos.",
  "codingAgent.folderLabel": "Carpeta de proyectos predeterminada",
  "codingAgent.folderPlaceholder": "/home/clawbox/Projects",
  "codingAgent.folderHelp": "Dónde trabaja una ejecución cuando tu asistente no nombra un proyecto. Debe ser una carpeta dentro del directorio personal de ClawBox — no la carpeta del propio ClawBox OS ni una con credenciales. Déjalo vacío para exigir un proyecto siempre.",
  ...
  "codingAgent.installed": "instalado",
  "codingAgent.connected": "conectado",
