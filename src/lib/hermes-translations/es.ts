...
export const es: Record<string, string> = {
  ...
  "codingAgent.liveView": "En vivo",
  "codingAgent.livePreviewTitle": "Terminal en vivo",
  "codingAgent.livePreviewShow": "Mostrar la terminal en vivo",
  "codingAgent.livePreviewHide": "Ocultar la terminal en vivo",
  "codingAgent.livePreviewClose": "Cerrar la terminal en vivo",
  "codingAgent.livePreviewOpenApp": "Abrir en Terminal",
  "codingAgent.livePreviewNotYet": "Nada que mostrar todavía — la ejecución aún no ha escrito su transcripción.",
  "codingAgent.homeRuns": "Ejecuciones fuera de tus proyectos",
