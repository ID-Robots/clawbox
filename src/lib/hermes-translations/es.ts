...
export const es: Record<string, string> = {
  ...
  "codingAgent.limits": "Una ejecución se detiene sola tras {turns} pasos o ${budget} de uso del modelo. No hay límite de tiempo: solo se detiene si queda en silencio mucho rato.",
