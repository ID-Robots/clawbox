...
export const es: Record<string, string> = {
  ...
  "codingAgent.effortLabel": "Esfuerzo de razonamiento",
  "codingAgent.effortHelp": "Cuánto se esfuerza el agente en cada paso. Más alto es más minucioso, pero más lento y cuesta más. Máximo es el valor por defecto, porque una ejecución delegada trabaja sin supervisión.",
  ...
  "codingAgent.fullAccessLabel": "Acceso total a comandos",
  "codingAgent.fullAccessHelp": "Por defecto, una ejecución solo puede usar comandos de compilación y prueba de una lista fija. Si lo activas, podrá ejecutar cualquier comando en su carpeta, incluidos los que borran archivos, instalan paquetes o acceden a la red.",
  "codingAgent.fullAccessOn": "Activado. Tus archivos de credenciales siguen protegidos y una ejecución sigue sin poder salir del home de ClawBox ni editar ClawBox — pero ya no hay límite sobre qué comandos ejecuta.",
  "codingAgent.fullAccessFailed": "No se pudo cambiar el acceso total a comandos.",
  "codingAgent.fullAccessBadge": "acceso total",
  ...
  "codingAgent.limitsHelp": "Una ejecución termina cuando acaba, agota sus pasos o alcanza el límite de tokens si estableces uno. No hay límite de tiempo ni de coste: un proyecto largo puede trabajar horas y solo se detiene solo si queda en silencio mucho rato.",
