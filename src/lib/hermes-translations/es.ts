...
export const es: Record<string, string> = {
  ...
  "localModels.detail.embeddingsOff": "La búsqueda en memoria aún no apunta a él. Configúralo en Memory Shard.",
  "localModels.detail.embeddingsNotInstalled": "No instalado. Configúralo en Memory Shard.",
