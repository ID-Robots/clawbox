...
export const es: Record<string, string> = {
  ...
  "codingAgent.clearRunsHint": "Elimina de la lista las ejecuciones terminadas y sus carpetas de evidencias. Se conservan las ejecuciones activas, en pausa o en borrador: aún mantienen una sesión que puede reanudar.",
  ...
  "codingAgent.prBlocked": "Le necesita",
  ...
  "codingAgent.wizardIntro": "El agente de código permite que su asistente delegue una tarea completa a Claude Code en esta caja: lee y escribe archivos en una carpeta, ejecuta comandos allí e informa del resultado. La configuración son dos pasos.",
  ...
  "codingAgent.wizardGithubHint": "Una ejecución sube su trabajo a GitHub con esta cuenta. Puede omitirlo y conectarlo más tarde en Ajustes: una ejecución funciona igual sin ello, solo que no tiene dónde subir.",
  ...
  "codingAgent.wizardProjectHint": "La carpeta en la que trabaja una ejecución cuando el asistente no nombra ningún proyecto. Explore para elegir una o escriba una ruta absoluta.",
  ...
  "codingAgent.wizardEffortCost": "Ultracode da los mejores resultados y consume muchos tokens: piensa más tiempo y puede ejecutar varios agentes para una sola tarea. Si lo usa a menudo, se recomienda un plan Business. Un esfuerzo menor cuesta menos y termina antes.",
  "codingAgent.wizardHarnessTitle": "Pruébelo una vez",
  "codingAgent.wizardHarnessHint": "Ejecute una tarea real y pequeña en un proyecto de prueba para demostrar que toda la cadena funciona: Claude Code arranca, escribe un archivo, controla el navegador e informa. Cuesta una ejecución. Puede omitirlo y lanzarlo cuando quiera desde la tarjeta «Prueba del entorno» en Ajustes.",
  ...
  "codingAgent.resetHint": "Desactiva el agente de código y borra la carpeta, el esfuerzo y los límites; después vuelve a ejecutarse el asistente de configuración. Se conservan su sesión de GitHub y su historial de ejecuciones.",
  ...
  "codingAgent.resetConfirm": "Restablecer todo — toque otra vez",
