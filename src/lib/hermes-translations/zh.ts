...
export const zh: Record<string, string> = {
  ...
  "codingAgent.team.help": "规划者把目标拆成任务，工作者在各自的会话中依次完成，审阅者检查每个结果。每一步都记录在下方的看板上。",
  ...
  "codingAgent.newTeamHint": "助手会在该文件夹中启动一个编码团队：规划者把目标拆成任务，工作者逐个完成，审核者检查每个结果。在 Coding Agent 应用的看板中跟进。",
