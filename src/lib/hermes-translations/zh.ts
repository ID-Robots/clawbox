...
export const zh: Record<string, string> = {
  ...
  "localModels.runtime.runsExtraModels": "在这台设备上运行额外的模型",
  ...
  "localModels.detail.ollamaNotInstalled": "未安装。",
  "localModels.detail.ollamaOff": "已关闭。请从菜单中开启。",
  "localModels.detail.ollamaStandby": "为节省内存已休眠。有模型被请求时会自动唤醒，也可以从菜单中立即开启。",
  "localModels.detail.ollamaFailed": "因出错而停止。请从菜单中开启。",
  "localModels.detail.ollamaChecking": "已开启。正在检查已下载的模型…",
  "localModels.detail.ollamaServing": "正在提供 {names}。",
  "localModels.detail.ollamaNoModels": "已开启，但尚未下载任何模型。",
  ...
  "localModels.detail.embeddingsOff": "没有记忆模型在响应，因此记忆搜索已关闭。",
  "localModels.detail.embeddingsAsleep": "{host} 正在休眠，记忆搜索已暂停，直到它被唤醒。",
  "localModels.detail.embeddingsPaused": "{host} 已关闭，因此记忆搜索已暂停。",
