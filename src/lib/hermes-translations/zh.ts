...
export const zh: Record<string, string> = {
  ...
  "skills.emptySearchAllSources": "改为搜索所有来源",
  "skills.emptySource": "{label} 中暂无内容",
  "skills.clearSourceFilter": "清除 {label} 筛选",
  ...
  "localModels.footer": "关闭某个模型会立即停止它，重启后也保持关闭。",
  ...
  "codingAgent.readyLine": "Claude Code、claude-ds 和 ClawBox AI 均已就绪。",
  "codingAgent.folderLabel": "默认项目文件夹",
  "codingAgent.folderPlaceholder": "/home/clawbox/Projects",
  "codingAgent.folderHelp": "当助手未指定代码项目时任务的工作位置。必须是 ClawBox 主目录中的文件夹 — 不能是 ClawBox OS 文件夹本身，也不能是存放凭据的文件夹。留空则每次都必须指定项目。",
  ...
  "codingAgent.installed": "已安装",
  "codingAgent.connected": "已连接",
  "codingAgent.missing": "缺失",
  "codingAgent.notConnected": "未连接",
  "codingAgent.effortLabel": "思考强度",
  "codingAgent.effortHelp": "编码助手在每一步的思考深度。越高越周全，但更慢也更花费。默认为最高，因为委派的运行无人看管。",
  ...
  "codingAgent.fullAccessLabel": "完全命令权限",
  "codingAgent.fullAccessHelp": "默认情况下，运行只能使用固定列表中的构建和测试命令。开启后，它可以在自己的文件夹中运行任何命令，包括删除文件、安装软件包或访问网络的命令。",
  "codingAgent.fullAccessOn": "已开启。你的凭据文件仍受保护，运行仍无法离开 ClawBox 主目录或修改 ClawBox 本身——但对它运行哪些命令不再有任何限制。",
  "codingAgent.fullAccessFailed": "无法更改完全命令权限。",
  "codingAgent.fullAccessBadge": "完全权限",
  ...
  "codingAgent.limitsHelp": "运行会在完成、用尽步数，或达到你设置的词元上限时结束。没有时间限制，也没有费用限制——长时间的项目可以运行数小时，只有长时间没有动静才会自行停止。",
