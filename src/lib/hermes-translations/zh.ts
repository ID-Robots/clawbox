...
export const zh: Record<string, string> = {
  ...
  "codingAgent.liveView": "实时查看",
  "codingAgent.livePreviewTitle": "实时终端",
  "codingAgent.livePreviewShow": "显示实时终端",
  "codingAgent.livePreviewHide": "隐藏实时终端",
  "codingAgent.livePreviewClose": "关闭实时终端",
  "codingAgent.livePreviewOpenApp": "在终端中打开",
  "codingAgent.livePreviewNotYet": "暂无内容——此运行尚未写入记录。",
