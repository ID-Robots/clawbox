...
export const zh: Record<string, string> = {
  ...
  "codingAgent.wizardIntro": "编程助手让助理把整项任务交给这台设备上的 Claude Code：它在一个文件夹内读写文件、执行命令，并汇报结果。设置只需两步。",
  ...
  "codingAgent.wizardGithubHint": "运行会用此账户把工作推送到 GitHub。您可以跳过，稍后在设置中连接——不连接也能运行，只是没有推送目标。",
  ...
  "codingAgent.resetHint": "关闭编程助手并清除文件夹、思考强度和上限，然后重新运行设置向导。您的 GitHub 登录和运行历史会保留。",
