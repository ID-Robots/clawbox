...
export const codingAgentEn: Record<string, string> = {
  ...
  "codingAgent.browserPreviewHide": "Hide",
  "codingAgent.browserPreviewShow": "Show",
  "codingAgent.liveViewMode": "Live view",
  "codingAgent.liveViewExit": "Exit live view",
  "codingAgent.liveWaiting": "Waiting for the run to open its transcript…",
  "codingAgent.team.title": "Coding team",
  "codingAgent.team.help": "A planner splits a goal into tasks, workers do them one after another in their own sessions, and a reviewer checks each result. Every step is on the board below.",
  "codingAgent.team.goalLabel": "The team's goal",
  "codingAgent.team.goalPlaceholder": "What should the team build or change in this project?",
  "codingAgent.team.start": "Start a team",
  "codingAgent.team.starting": "Starting…",
  "codingAgent.team.stop": "Stop the team",
  "codingAgent.team.startFailed": "Could not start the team.",
