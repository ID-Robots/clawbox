...
export const codingAgentEn: Record<string, string> = {
  ...
  "codingAgent.newTeamHint": "The assistant starts a coding team in that folder: a planner splits the goal into tasks, workers do them one after another, and a reviewer checks each result. Follow the board in the Coding Agent app.",
