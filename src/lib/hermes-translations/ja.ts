...
export const ja: Record<string, string> = {
  ...
  "codingAgent.fullAccessHelp": "実行がビルドやテスト以外の任意のコマンドを使えるようにします。",
  "codingAgent.fullAccessOn": "実行はこの端末のあらゆるファイルを読み書きできるようになります。保存された鍵やパスワードも含みます。信頼できる作業のときだけ有効にしてください。",
