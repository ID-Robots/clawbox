...
export const ja: Record<string, string> = {
  ...
  "codingAgent.liveView": "ライブ表示",
  "codingAgent.livePreviewTitle": "ライブターミナル",
  "codingAgent.livePreviewShow": "ライブターミナルを表示",
  "codingAgent.livePreviewHide": "ライブターミナルを隠す",
  "codingAgent.livePreviewClose": "ライブターミナルを閉じる",
  "codingAgent.livePreviewOpenApp": "ターミナルで開く",
  "codingAgent.livePreviewNotYet": "まだ表示するものがありません — 実行がトランスクリプトを書き出していません。",
