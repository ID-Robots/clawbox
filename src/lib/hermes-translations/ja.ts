...
export const ja: Record<string, string> = {
  ...
  "codingAgent.team.goalLabel": "チームの目標",
  "codingAgent.team.goalPlaceholder": "このプロジェクトでチームに何を作らせ、何を変えさせますか？",
  "codingAgent.team.start": "チームを開始",
  "codingAgent.team.starting": "開始しています…",
  "codingAgent.team.stop": "チームを停止",
  "codingAgent.team.startFailed": "チームを開始できませんでした。",
