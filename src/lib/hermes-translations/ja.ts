...
export const ja: Record<string, string> = {
  ...
  "codingAgent.readyLine": "Claude Code、claude-ds、ClawBox AI はすべて準備できています。",
  "codingAgent.folderLabel": "既定のプロジェクトフォルダー",
  "codingAgent.folderPlaceholder": "/home/clawbox/Projects",
  "codingAgent.folderHelp": "アシスタントがコードプロジェクトを指定しないときに実行が作業する場所です。ClawBox のホーム内のフォルダーである必要があります — ClawBox OS のフォルダー自体や認証情報を含むフォルダーは指定できません。空にすると毎回プロジェクトの指定が必要になります。",
  ...
  "codingAgent.installed": "インストール済み",
  "codingAgent.connected": "接続済み",
  "codingAgent.missing": "未インストール",
  "codingAgent.notConnected": "未接続",
  "codingAgent.effortLabel": "思考の深さ",
  "codingAgent.effortHelp": "各ステップでどこまで考えるか。高いほど丁寧ですが、遅くなり費用も増えます。委任した実行は無人で動くため、既定は最大です。",
  ...
  "codingAgent.fullAccessLabel": "コマンドの完全アクセス",
  "codingAgent.fullAccessHelp": "既定では、実行は決められた一覧にあるビルドとテストのコマンドしか使えません。これを有効にすると、ファイルの削除、パッケージのインストール、ネットワーク利用を含む任意のコマンドをフォルダー内で実行できます。",
  "codingAgent.fullAccessOn": "有効です。認証情報のファイルは保護されたままで、実行は今も ClawBox のホームの外に出たり ClawBox 自体を編集したりできません。ただし、実行するコマンドの制限はなくなります。",
  "codingAgent.fullAccessFailed": "コマンドの完全アクセスを変更できませんでした。",
  "codingAgent.fullAccessBadge": "完全アクセス",
  ...
  "codingAgent.limitsHelp": "実行は、完了したとき、ステップを使い切ったとき、または設定した場合はトークン上限に達したときに終了します。時間制限も費用制限もありません。長いプロジェクトは何時間でも作業でき、長く沈黙した場合にのみ自動で停止します。",
