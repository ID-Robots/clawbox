...
export const ja: Record<string, string> = {
  ...
  "codingAgent.team.help": "プランナーが目標をタスクに分け、ワーカーがそれぞれのセッションで順番に実行し、レビュアーが各結果を確認します。すべての手順は下のボードに記録されます。",
  ...
  "codingAgent.newTeamHint": "アシスタントがそのフォルダーでコーディングチームを開始します。プランナーが目標をタスクに分け、ワーカーが順番に実行し、レビュアーが各結果を確認します。Coding Agent アプリのボードで進行を確認できます。",
