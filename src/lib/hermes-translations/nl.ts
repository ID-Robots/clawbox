...
export const nl: Record<string, string> = {
  ...
  "codingAgent.team.help": "Een planner splitst het doel in taken, werkers voeren ze na elkaar uit in eigen sessies en een beoordelaar controleert elk resultaat. Elke stap staat op het bord hieronder.",
  ...
  "codingAgent.newTeamHint": "De assistent start een codeerteam in die map: een planner splitst het doel in taken, workers voeren ze na elkaar uit en een reviewer controleert elk resultaat. Volg het bord in de Coding Agent-app.",
