...
export const nl: Record<string, string> = {
  ...
  "localModels.detail.embeddingsOff": "Geheugenzoeken wijst er nog niet naar. Stel het in via Memory Shard.",
  "localModels.detail.embeddingsNotInstalled": "Niet geïnstalleerd. Stel het in via Memory Shard.",
