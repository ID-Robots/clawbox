...
export const nl: Record<string, string> = {
  ...
  "codingAgent.fullAccessHelp": "Laat een run elke opdracht gebruiken, niet alleen build- en testtools.",
  "codingAgent.fullAccessOn": "Een run kan nu elk bestand op dit apparaat lezen en wijzigen, inclusief je opgeslagen sleutels en wachtwoorden. Zet dit alleen aan voor taken die je vertrouwt.",
