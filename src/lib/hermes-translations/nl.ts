...
export const nl: Record<string, string> = {
  ...
  "codingAgent.wizardIntro": "Met de codeagent geeft je assistent een hele taak door aan Claude Code op deze box: hij leest en schrijft bestanden in één map, voert daar opdrachten uit en rapporteert terug. Instellen kost drie stappen.",
