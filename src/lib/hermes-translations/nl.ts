...
export const nl: Record<string, string> = {
  ...
  "skills.facetCountsLoaded": "De aantallen gelden voor de {n} geladen vaardigheden, niet voor de hele catalogus.",
  ...
  "skills.liveResults.one": "{n} vaardigheid komt overeen",
  "skills.liveResults.other": "{n} vaardigheden komen overeen",
  "skills.liveResults.none": "Geen vaardigheden komen overeen",
