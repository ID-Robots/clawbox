...
export const nl: Record<string, string> = {
  ...
  "codingAgent.liveView": "Live weergave",
  "codingAgent.livePreviewTitle": "Live-terminal",
  "codingAgent.livePreviewShow": "Live terminal tonen",
  "codingAgent.livePreviewHide": "Live terminal verbergen",
  "codingAgent.livePreviewClose": "Live terminal sluiten",
  "codingAgent.livePreviewOpenApp": "Openen in Terminal",
  "codingAgent.livePreviewNotYet": "Nog niets te tonen — de run heeft zijn transcript nog niet geschreven.",
