...
export const nl: Record<string, string> = {
  ...
  "localModels.runtime.runsExtraModels": "Draait extra modellen op deze box",
  ...
  "localModels.detail.ollamaNotInstalled": "Niet geïnstalleerd.",
  "localModels.detail.ollamaOff": "Uit. Schakel het in via het menu.",
  "localModels.detail.ollamaStandby": "Slaapt om geheugen te sparen. Wordt wakker zodra er om een model wordt gevraagd, of schakel het nu in via het menu.",
  "localModels.detail.ollamaFailed": "Gestopt na een fout. Schakel het in via het menu.",
  "localModels.detail.ollamaChecking": "Aan. Er wordt gecontroleerd welke modellen zijn gedownload…",
  "localModels.detail.ollamaServing": "Serveert {names}.",
  "localModels.detail.ollamaNoModels": "Aan, maar er zijn nog geen modellen gedownload.",
  ...
  "localModels.detail.embeddingsOff": "Geen geheugenmodel antwoordt, dus zoeken in het geheugen staat uit.",
  "localModels.detail.embeddingsAsleep": "{host} slaapt, dus zoeken in het geheugen is gepauzeerd tot het wakker wordt.",
  "localModels.detail.embeddingsPaused": "{host} staat uit, dus zoeken in het geheugen is gepauzeerd.",
