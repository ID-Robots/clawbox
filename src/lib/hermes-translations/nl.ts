...
export const nl: Record<string, string> = {
  ...
  "codingAgent.readyLine": "Claude Code, claude-ds en ClawBox AI zijn klaar.",
  "codingAgent.folderLabel": "Standaard projectmap",
  "codingAgent.folderPlaceholder": "/home/clawbox/Projects",
  "codingAgent.folderHelp": "Waar een run werkt als je assistent geen codeproject noemt. Moet een map in de ClawBox-home zijn — niet de ClawBox OS-map zelf en geen map met inloggegevens. Laat leeg om elke keer een project te vereisen.",
  ...
  "codingAgent.installed": "geïnstalleerd",
  "codingAgent.connected": "verbonden",
  "codingAgent.missing": "ontbreekt",
  "codingAgent.notConnected": "niet verbonden",
  "codingAgent.effortLabel": "Denkinspanning",
  "codingAgent.effortHelp": "Hoe grondig de coding agent bij elke stap nadenkt. Hoger is grondiger, maar trager en duurder. Max is de standaard, omdat een gedelegeerde run zonder toezicht werkt.",
  "codingAgent.effort.low": "Laag",
  "codingAgent.effort.medium": "Gemiddeld",
  "codingAgent.effort.high": "Hoog",
  ...
  "codingAgent.fullAccessLabel": "Volledige opdrachttoegang",
  "codingAgent.fullAccessHelp": "Standaard mag een run alleen build- en testopdrachten uit een vaste lijst gebruiken. Zet je dit aan, dan mag hij elke opdracht in zijn map uitvoeren, ook opdrachten die bestanden verwijderen, pakketten installeren of het netwerk gebruiken.",
  "codingAgent.fullAccessOn": "Aan. Je inloggegevens blijven beschermd en een run kan nog steeds niet buiten de ClawBox-home komen of ClawBox zelf bewerken — maar er is geen grens meer aan welke opdrachten hij uitvoert.",
  "codingAgent.fullAccessFailed": "De volledige opdrachttoegang kon niet worden gewijzigd.",
  "codingAgent.fullAccessBadge": "volledige toegang",
  "codingAgent.turnsLabel": "Stappen per run",
  "codingAgent.turnsFailed": "Het stappenlimiet kon niet worden gewijzigd.",
  "codingAgent.tokensLabel": "Tokenlimiet (optioneel)",
  "codingAgent.tokensPlaceholder": "geen limiet",
  "codingAgent.tokensFailed": "De tokenlimiet kon niet worden gewijzigd.",
  "codingAgent.limitsHelp": "Een run eindigt wanneer hij klaar is, zijn stappen opraken of de tokenlimiet bereikt als je er een instelt. Er is geen tijdslimiet en geen kostenlimiet — een lang project mag uren werken en stopt alleen vanzelf als het lang stil blijft.",
