...
export const nl: Record<string, string> = {
  ...
  "codingAgent.liveViewMode": "Liveweergave",
  "codingAgent.liveViewExit": "Liveweergave sluiten",
  "codingAgent.liveWaiting": "Wachten tot de run zijn transcript opent…",
  ...
  "codingAgent.helpersTitle": "Helpers aan het werk",
