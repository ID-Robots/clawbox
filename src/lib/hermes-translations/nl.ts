...
export const nl: Record<string, string> = {
  ...
  "codingAgent.clearRunsHint": "Verwijdert afgeronde runs en hun bewijsmappen uit de lijst. Actieve, gepauzeerde en concept-runs blijven staan — die houden nog een sessie vast die u kunt hervatten.",
  ...
  "codingAgent.prBlocked": "Heeft u nodig",
  ...
  "codingAgent.wizardGithubHint": "Een run pusht zijn werk met dit account naar GitHub. U kunt dit overslaan en later verbinden in Instellingen — een run werkt ook zonder, hij heeft dan alleen nergens om naartoe te pushen.",
  ...
  "codingAgent.wizardHarnessHint": "Voer een kleine, echte taak uit in een kladproject om te bewijzen dat de hele keten werkt: Claude Code start, schrijft een bestand, bestuurt de browser en rapporteert terug. Het kost één run. U kunt dit overslaan en het altijd starten via de kaart 'Testrun' in Instellingen.",
  ...
  "codingAgent.resetHint": "Schakelt de codeagent uit en wist map, inspanning en limieten; daarna loopt de installatiewizard opnieuw. Uw GitHub-aanmelding en uw rungeschiedenis blijven behouden.",
