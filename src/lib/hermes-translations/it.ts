...
export const it: Record<string, string> = {
  ...
  "codingAgent.clearRunsHint": "Rimuove dall'elenco le esecuzioni concluse e le loro cartelle di prove. Restano quelle attive, in pausa o in bozza: mantengono ancora una sessione che può riprendere.",
  ...
  "codingAgent.prBlocked": "Serve lei",
  ...
  "codingAgent.wizardGithubHint": "Un'esecuzione carica il proprio lavoro su GitHub con questo account. Può saltare questo passaggio e collegarlo più tardi in Impostazioni: un'esecuzione funziona anche senza, semplicemente non ha dove caricare.",
  ...
  "codingAgent.wizardProjectHint": "La cartella in cui lavora un'esecuzione quando l'assistente non indica alcun progetto. Sfogli per sceglierne una, oppure digiti un percorso assoluto.",
  ...
  "codingAgent.wizardEffortCost": "Ultracode dà i risultati migliori e consuma moltissimi token: ragiona più a lungo e può avviare più agenti per una sola attività. Se lo usa spesso è consigliato un piano Business. Uno sforzo inferiore costa meno e finisce prima.",
  "codingAgent.wizardHarnessTitle": "Provi una volta",
  "codingAgent.wizardHarnessHint": "Esegua una piccola attività reale in un progetto di prova per dimostrare che l'intera catena funziona: Claude Code parte, scrive un file, guida il browser e riferisce. Costa un'esecuzione. Può saltare questo passaggio e avviarlo quando vuole dalla scheda «Prova dell'ambiente» in Impostazioni.",
  ...
  "codingAgent.resetHint": "Disattiva l'agente di codice e cancella cartella, sforzo e limiti, poi la procedura guidata viene eseguita di nuovo. L'accesso a GitHub e la cronologia delle esecuzioni vengono mantenuti.",
  ...
  "codingAgent.resetConfirm": "Reimposta tutto — tocchi di nuovo",
