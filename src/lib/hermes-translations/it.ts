...
export const it: Record<string, string> = {
  ...
  "codingAgent.limits": "Un'esecuzione si ferma da sola dopo {turns} passi o ${budget} di utilizzo del modello. Non c'è limite di tempo: si ferma solo se resta in silenzio a lungo.",
