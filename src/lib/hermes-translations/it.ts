...
export const it: Record<string, string> = {
  ...
  "skills.facetCountsLoaded": "I conteggi riguardano le {n} skill caricate, non l'intero catalogo.",
  ...
  "skills.liveResults.one": "{n} skill corrisponde",
  "skills.liveResults.other": "{n} skill corrispondono",
  "skills.liveResults.none": "Nessuna skill corrisponde",
