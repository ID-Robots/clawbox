...
export const it: Record<string, string> = {
  ...
  "codingAgent.team.help": "Un pianificatore divide l'obiettivo in attività, i lavoratori le svolgono una dopo l'altra in sessioni proprie e un revisore controlla ogni risultato. Ogni passo è sulla lavagna qui sotto.",
  ...
  "codingAgent.newTeamHint": "L'assistente avvia un team di programmazione in quella cartella: un pianificatore divide l'obiettivo in attività, i worker le svolgono una dopo l'altra e un revisore controlla ogni risultato. Segui la lavagna nell'app Coding Agent.",
