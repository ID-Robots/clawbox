...
export const it: Record<string, string> = {
  ...
  "codingAgent.liveViewMode": "Vista dal vivo",
  "codingAgent.liveViewExit": "Esci dalla vista dal vivo",
  "codingAgent.liveWaiting": "In attesa che l'esecuzione apra la sua trascrizione…",
