...
export const it: Record<string, string> = {
  ...
  "codingAgent.newNamePlaceholder": "Timer Pomodoro",
  "codingAgent.newWhatLabel": "Cosa deve fare?",
  "codingAgent.newWhatPlaceholder": "Un timer con blocchi di lavoro da 25 minuti e pause da 5, con un suono alla fine di ciascuno.",
