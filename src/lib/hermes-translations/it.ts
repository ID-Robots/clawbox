...
export const it: Record<string, string> = {
  ...
  "codingAgent.terminalHint": "Le attività di programmazione delegate dal tuo assistente. Per una sessione interattiva apri l'app Terminale ed esegui claude-ds.",
  ...
  "codingAgent.switchHelp": "Se attivo, l'assistente può affidare un compito di programmazione a Claude Code, che lavora in background in una cartella di progetto con il tuo piano ClawBox AI e riferisce al termine. Disattivato per impostazione predefinita.",
  "codingAgent.readiness": "Cosa serve a un'esecuzione",
  "codingAgent.readyLine": "Claude Code, claude-ds e ClawBox AI sono pronti.",
  "codingAgent.folderLabel": "Cartella progetti predefinita",
  "codingAgent.folderPlaceholder": "/home/clawbox/Projects",
  "codingAgent.folderHelp": "Dove lavora un'esecuzione quando l'assistente non indica un progetto. Deve essere una cartella nella home di ClawBox — non la cartella di ClawBox OS stessa né una con credenziali. Lascia vuoto per richiedere sempre un progetto.",
  ...
  "codingAgent.installed": "installato",
  "codingAgent.connected": "connesso",
  "codingAgent.missing": "mancante",
  "codingAgent.notConnected": "non connesso",
  "codingAgent.effortLabel": "Sforzo di ragionamento",
  "codingAgent.effortHelp": "Quanto si impegna l'agente a ogni passo. Più alto è più accurato, ma più lento e costoso. Massimo è il valore predefinito, perché un'esecuzione delegata lavora senza supervisione.",
  ...
  "codingAgent.fullAccessLabel": "Accesso completo ai comandi",
  "codingAgent.fullAccessHelp": "Per impostazione predefinita un'esecuzione può usare solo comandi di build e test da un elenco fisso. Attivandolo potrà eseguire qualsiasi comando nella sua cartella, compresi quelli che cancellano file, installano pacchetti o usano la rete.",
  "codingAgent.fullAccessOn": "Attivo. I file delle credenziali restano protetti e un'esecuzione non può ancora uscire dalla home di ClawBox né modificare ClawBox — ma non c'è più alcun limite sui comandi che esegue.",
  "codingAgent.fullAccessFailed": "Non è stato possibile cambiare l'accesso completo ai comandi.",
  "codingAgent.fullAccessBadge": "accesso completo",
  ...
  "codingAgent.limitsHelp": "Un'esecuzione finisce quando ha concluso, esaurisce i passi o raggiunge il limite di token se ne imposti uno. Non c'è limite di tempo né di costo: un progetto lungo può lavorare per ore e si ferma da solo solo se resta in silenzio a lungo.",
