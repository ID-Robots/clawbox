...
export const it: Record<string, string> = {
  ...
  "codingAgent.fullAccessHelp": "Consente a un'esecuzione di usare qualsiasi comando, non solo strumenti di build e test.",
  "codingAgent.fullAccessOn": "Un'esecuzione può ora leggere e modificare qualsiasi file su questo dispositivo, incluse le chiavi e le password salvate. Attivalo solo per attività di cui ti fidi.",
