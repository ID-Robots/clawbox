...
export const it: Record<string, string> = {
  ...
  "localModels.detail.embeddingsOff": "La ricerca in memoria non punta ancora a questo modello. Configurala in Memory Shard.",
  "localModels.detail.embeddingsNotInstalled": "Non installato. Configuralo in Memory Shard.",
