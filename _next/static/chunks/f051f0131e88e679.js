(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,638601,t=>{"use strict";t.s(["createViewTransitionMorph",()=>U,"ensureVtStructuralStyles",()=>K],638601),t.s([],3478),t.i(247167);var e=t.i(174080),r=t.i(505661),n=t.i(932783);let o=0,i=!1,a=!1;function s(){a=!0}function u(t){t.cancelable&&t.preventDefault()}function l(t){t.touches.length>0||(a=!1,0===o&&m())}function m(){i&&(i=!1,document.removeEventListener("touchstart",s,{capture:!0}),document.removeEventListener("touchmove",u,{capture:!0}),document.removeEventListener("touchend",l,{capture:!0}),document.removeEventListener("touchcancel",l,{capture:!0}))}function c(){if("undefined"==typeof document)return()=>{};o+=1,i||(i=!0,a=!1,document.addEventListener("touchstart",s,{capture:!0,passive:!0}),document.addEventListener("touchmove",u,{capture:!0,passive:!1}),document.addEventListener("touchend",l,{capture:!0,passive:!0}),document.addEventListener("touchcancel",l,{capture:!0,passive:!0}));let t=!1;return()=>{!t&&(t=!0,0!=(o-=1)||a||m())}}var d=t.i(27501),p=t.i(277086),h=t.i(774339);let f=t=>Number(t.toFixed(4));function g(t){let[e=0,r=e,n=e,o=r]=t.trim().split(/\s+/).map(t=>Number.parseFloat(t)).filter(t=>Number.isFinite(t)&&t>=0);return[e,r,n,o]}var v=t.i(271412),b=t.i(973869);let y=Symbol.for("ramka.vt.adoptedMarkers");function $(t,e,r=!1){if("undefined"!=typeof document){if((0,b.supportsConstructedSheets)()){var n;let r=(n=document)[y]??(n[y]=new Set);if(r.has(t))return;r.add(t),(0,b.adopt)(e());return}document.head.querySelector(`style[${t}]`)||(0,b.appendStyleElement)(e(),t,r)}}let w="data-ramka-vt-composited",x="data-ramka-vt-composited-css",T=0,E="inset: 0 auto auto 0 !important;",R=`::view-transition-group(${d.VIEW_TRANSITION_NAME})`,A=`::view-transition-old(${d.VIEW_TRANSITION_NAME})`,N=`::view-transition-new(${d.VIEW_TRANSITION_NAME})`;function D(t,e,r){let n="borderRadius"===r?"border-radius":"transform",o=e.map(t=>`${(100*t.offset).toFixed(3)}% { ${n}: ${String(t[r])}; }`).join("\n");return`@keyframes ${t} {
${o}
...
`}function K(){$("data-ramka-lightbox-vt-styles",q,!0)}t.i(3478)}]);